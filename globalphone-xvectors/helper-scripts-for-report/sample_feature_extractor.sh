...
pitch_config=conf/feature_configs/kaldi_pitch.conf
pitch_postprocess_config=conf/feature_configs/kaldi_pitch_process.conf
energy_config=conf/feature_configs/mfcc_energy.conf
vad_config=conf/feature_configs/vad.conf
mfcc_config=conf/feature_configs/mfcc.conf
